                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="status" id="status" style="text-transform:capitalize;" required>
                                    <option value="{{$agency->status}}" selected>{{$agency->status}}</option>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <select class="select2" name="plan_id" id="plan_id">
                                    ...
                                    @if ($agency->plan_id)
                                    <option value="{{$agency->plan->id ?? ''}}" checked>{{$agency->plan->name}}</option>
                                    @else
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input type="date"
                                class="form-control" name="start_date" id="start_date" aria-describedby="start_date" required value="{{ old('start_date') ?? $agency->start_date }}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date"
                                  class="form-control" name="end_date" id="end_date" aria-describedby="end_date" value="{{ old('end_date') ?? $agency->end_date }}">
                              </div>
                        </div>
                    </div>

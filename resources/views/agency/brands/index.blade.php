@extends('agency.layouts.app', ['page_action' => 'Brand List'])
@section('style')
    ...
    <div class="row align-items-md-center">
        ...
        <div class="col-md-6">
            <div class="text-md-right m-v-10">
                <span class="text-muted pr-3 pt-2 p">Total Result: {{count($brands)}}</span>
                ...
                <button class="btn btn-primary m-r-5 ml-2 btn-sm" data-toggle="modal" data-target="#add_brand" >
...
{{-- Limit message --}}
@if (Session::has('brand_limit'))
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        <span class="sr-only">Close</span>
    </button>
    {{ Session::get('brand_limit') }} - <a href="{{route('agency.plans.index')}}">Upgrade Plan</a>
</div>
@endif
...
<div class="container-fluid">
                ...
                <div class="card" style="margin-bottom: 10px;">
                    ...
                    <div class="card-footer" style="padding: 0.7rem;">
                        <div class="text-right">
                            ...
                            <a href="{{route('agency.brands.edit', $data->id)}}" class="btn btn-primary btn-xs">Edit</a>
                            
                            <form style="display: none;" id="delete-form{{$data->id}}" method="POST" action="{{route('agency.brands.destroy', $data->id)}}" >
                                @csrf @method('DELETE')
                            </form>
    ...
    {!! $brands->appends(array("name" => request()->get('name','') ))->links() !!}
</div>
...
{{-- Filter Form Blade --}}
@include('agency.brands.parts.filter_form')

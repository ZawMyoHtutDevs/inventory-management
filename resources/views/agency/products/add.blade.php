@extends('agency.layouts.app', ['page_action' => 'Add Product'])
@section('style')
...
<form method="POST" action="{{ route('agency.products.store') }}" enctype="multipart/form-data">
    @csrf
<div class="row ">
    <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="supplier_id" id="supplier_id" style="text-transform:capitalize;" required>
                                <option value="" selected>Selete Supplier</option>                                
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            ...
                            <input id="quantity" type="number" class="form-control @error('quantity') is-invalid @enderror" name="quantity" value="{{ old('quantity') }}" autocomplete="quantity">
                            @error('quantity')
                            <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="price" class="form-control @error('price') is-invalid @enderror " value="{{ old('price') }}" required placeholder="15000" aria-label="15000" aria-describedby="basic-addon2">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" name="sale_price" class="form-control @error('sale_price') is-invalid @enderror " value="{{ old('sale_price') }}" required placeholder="20000" aria-label="20000" aria-describedby="basic-addon3">
                            <div class="input-group-append">
        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group">
                    ...
                    <select class="form-control" name="category_id" id="category_id" style="text-transform:capitalize;" required>
                  ...
                  <div class="form-group pt-4">
                    ...
                    <select class="form-control" name="brand_id" id="brand_id" style="text-transform:capitalize;" required>
                        <option value="" selected>Selete Brand</option>                                

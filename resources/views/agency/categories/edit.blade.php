@extends('agency.layouts.app', ['page_action' => 'Edit Category'])
@section('style')
...
<div class="page-header mb-3">
    ...
    <div class="header-sub-title">
        <nav class="breadcrumb breadcrumb-dash">
            ...
            <a class="breadcrumb-item" href="{{route('agency.categories.index')}}">Categories</a>
...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <form method="POST" action="{{ route('agency.categories.update', $category->id) }}">
            @csrf @method('PUT')
            <div class="card">
                <div class="card-body">
                    ...
                    <a name="" id="" class="btn btn-outline-primary float-right ml-1" href="{{ route('agency.categories.index')}}" role="button">Close</a>

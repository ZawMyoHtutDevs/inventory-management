@extends('agency.layouts.app', ['page_action' => 'Supplier List'])
@section('style')
    ...
    <div class="row align-items-md-center">
        ...
        <div class="col-md-6">
            <div class="text-md-right m-v-10">
                <span class="text-muted pr-3 pt-2 p">Total Result: {{count($suppliers)}}</span>
                ...
                <button class="btn btn-primary m-r-5 ml-2 btn-sm" data-toggle="modal" data-target="#add_supplier" >
...
{{-- Limit message --}}
@if (Session::has('supplier_limit'))
<div class="alert alert-danger alert-dismissible fade show" role="alert">
    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        <span aria-hidden="true">&times;</span>
        <span class="sr-only">Close</span>
    </button>
    {{ Session::get('supplier_limit') }} - <a href="{{route('agency.plans.index')}}">Upgrade Plan</a>
</div>
@endif
...
<div class="container-fluid">
                ...
                <div class="card" style="margin-bottom: 10px;">
                    ...
                    <div class="card-footer" style="padding: 0.7rem;">
                        <div class="text-right">
                            ...
                            <a href="{{route('agency.suppliers.edit', $data->id)}}" class="btn btn-primary btn-xs">Edit</a>
                            <a href="{{route('agency.suppliers.view', $data->id)}}" class="btn btn-info btn-xs">View</a>

                            <form style="display: none;" id="delete-form{{$data->id}}" method="POST" action="{{route('agency.suppliers.destroy', $data->id)}}" >
                                @csrf @method('DELETE')
                            </form>
    ...
    {!! $suppliers->appends(array("name" => request()->get('name',''),"phone" => request()->get('phone','') ))->links() !!}
</div>
...
{{-- Filter Form Blade --}}
@include('agency.suppliers.parts.filter_form')

...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <form method="POST" action="{{ route('agency.customers.update', $customer->id) }}">
            @csrf @method('PUT')
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                ...
                                <input id="phone" type="phone" class="form-control @error('phone') is-invalid @enderror" name="phone" value="{{old('phone') ?? $customer->phone }}" required autocomplete="phone">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <input id="address" type="text" class="form-control @error('address') is-invalid @enderror" name="address" value="{{ old('address') ?? $customer->address }}" required autocomplete="address" autofocus>
                                @error('address')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                    ...
                    <a name="" id="" class="btn btn-outline-primary float-right ml-1" href="{{ route('agency.customers.index')}}" role="button">Close</a>
